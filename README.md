...
# <a id="apr"/> Running automated program repair experiments 
...
```bash
cd learn2fix-journal-ext/experiments
./experiments_dct_noise.sh <<path to codeflaws directory>> <<noise_level 0 - 1 >>
```
