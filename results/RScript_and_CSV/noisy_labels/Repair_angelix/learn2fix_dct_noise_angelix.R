...
d=read.table("results_repair_incal.csv",sep=",",comment.char = "#")
...
print(wilcox.test(subset(patch_quality2,noise_level=="Manual")$value,subset(patch_quality2,noise_level=="autogen-5%")$value,alternative="less"))
print(wilcox.test(subset(patch_quality2,noise_level=="Manual")$value,subset(patch_quality2,noise_level=="autogen-10%")$value,alternative="less"))
print(wilcox.test(subset(patch_quality2,noise_level=="Manual")$value,subset(patch_quality2,noise_level=="autogen-20%")$value,alternative="less"))
...
print(paste("Average/Median manual Validation Score (Manual) : ", mean(subset(patch_quality2,  noise_level == "Manual" & value!=Inf)$value,na.rm = TRUE),median(subset(patch_quality2,  noise_level == "Manual"& value!=Inf)$value,na.rm = TRUE)))
